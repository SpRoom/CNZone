...
extension EdgeInsets {
    ...
    public func insetBy(top: CGFloat) -> EdgeInsets {
    ...
    /// - Returns: EdgeInsets offset with given offset.
    public func insetBy(left: CGFloat) -> EdgeInsets {
    ...
    /// - Returns: EdgeInsets offset with given offset.
    public func insetBy(bottom: CGFloat) -> EdgeInsets {
    ...
    /// - Returns: EdgeInsets offset with given offset.
    public func insetBy(right: CGFloat) -> EdgeInsets {
    ...
    /// - Returns: EdgeInsets offset with given offset.
    public func insetBy(horizontal: CGFloat) -> EdgeInsets {
    ...
    /// - Returns: EdgeInsets offset with given offset.
    public func insetBy(vertical: CGFloat) -> EdgeInsets {
...
extension EdgeInsets {
    ...
    public static func +(_ lhs: EdgeInsets, _ rhs: EdgeInsets) -> EdgeInsets {
    ...
    ///   - rhs: The right-hand expression
    public static func +=(_ lhs: inout EdgeInsets, _ rhs: EdgeInsets) {
        lhs.top += rhs.top
        lhs.left += rhs.left
        lhs.bottom += rhs.bottom
        lhs.right += rhs.right
