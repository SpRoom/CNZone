...
extension String {
    ...
    ///
    public var regexEscaped: String {
...
extension String {
    ...
    public subscript<R>(safe range: R) -> String? where R: RangeExpression, R.Bound == Int {
    ...
    public func replacingOccurrences(of regex: NSRegularExpression,
...
extension String {
    ...
    public func colored(with color: Color) -> NSAttributedString {
...
extension String {
    ...
    public var fullNSRange: NSRange { NSRange(startIndex..<endIndex, in: self) }
