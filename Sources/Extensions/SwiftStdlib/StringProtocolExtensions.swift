...
extension StringProtocol {
    ...
    public func replacingOccurrences<Target, Replacement>(ofPattern pattern: Target,
        ...
        assert(options.isStrictSubset(of: [.regularExpression, .anchored, .caseInsensitive]),
