...
extension MutableCollection where Self: RandomAccessCollection {
    ...
    public mutating func sort<T>(by keyPath: KeyPath<Element, T>, with compare: (T, T) -> Bool) {
    ...
    public mutating func sort<T: Comparable, U: Comparable>(by keyPath1: KeyPath<Element, T>,
    ...
    public mutating func sort<T: Comparable, U: Comparable, V: Comparable>(by keyPath1: KeyPath<Element, T>,
                                                                           and keyPath2: KeyPath<Element, U>,
...
extension MutableCollection {
    ...
    public mutating func assignToAll<Value>(value: Value, by keyPath: WritableKeyPath<Element, Value>) {
        for idx in indices {
