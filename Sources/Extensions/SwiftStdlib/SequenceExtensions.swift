...
extension Sequence {
    ...
    public func withoutDuplicates<T: Hashable>(transform: (Element) throws -> T) rethrows -> [Element] {
        var set = Set<T>()
    ...
    public func sorted<T>(by keyPath: KeyPath<Element, T>, with compare: (T, T) -> Bool) -> [Element] {
    ...
    public func sorted<T: Comparable, U: Comparable>(by keyPath1: KeyPath<Element, T>,
    ...
    public func sorted<T: Comparable, U: Comparable, V: Comparable>(by keyPath1: KeyPath<Element, T>,
    ...
    public func sum<T: AdditiveArithmetic>(for keyPath: KeyPath<Element, T>) -> T {
    ...
    public func first<T: Equatable>(where keyPath: KeyPath<Element, T>, equals value: T) -> Element? {
