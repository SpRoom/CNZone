...
extension Array {
    ...
    public func sorted<T: Comparable>(by path: KeyPath<Element, T?>, ascending: Bool) -> [Element] {
        if ascending {
    ...
    @discardableResult
    public mutating func sort<T: Comparable>(by path: KeyPath<Element, T?>, ascending: Bool) -> [Element] {
        if ascending {
...
extension Sequence {
    ...
    public func compactMap<T>(by keyPath: KeyPath<Element, T?>) -> [T] {
