...
extension Array {
    ...
    public func sorted<T: Hashable>(like otherArray: [T], keyPath: KeyPath<Element, T>) -> [Element] {
...
extension Array where Element: Equatable {
    ...
    /// - Returns: an array of unique elements.
    public func withoutDuplicates<E: Equatable>(keyPath path: KeyPath<Element, E>) -> [Element] {
    ...
    /// - Returns: an array of unique elements.
    public func withoutDuplicates<E: Hashable>(keyPath path: KeyPath<Element, E>) -> [Element] {
        var set = Set<E>()
