...
extension Date {
    ...
    private var dateComponents: DateComponents {
        calendar.dateComponents([.era, .year, .month, .day, .hour, .minute, .second, .nanosecond, .weekday], from: self)
    }
    ...
    public static func +(left: Date, right: DateComponents) -> Date? {
        Calendar.current.date(byAdding: right, to: left)
    }
    ...
    public func changed(year: Int) -> Date? {
        changed(year: year, month: nil, day: nil, hour: nil, minute: nil, second: nil, nanosecond: nil)
    }
    ...
    public func changed(month: Int) -> Date? {
        changed(year: nil, month: month, day: nil, hour: nil, minute: nil, second: nil, nanosecond: nil)
    }
    ...
    public func changed(day: Int) -> Date? {
        changed(year: nil, month: nil, day: day, hour: nil, minute: nil, second: nil, nanosecond: nil)
    }
    ...
    public func changed(hour: Int) -> Date? {
        changed(year: nil, month: nil, day: nil, hour: hour, minute: nil, second: nil, nanosecond: nil)
    }
    ...
    public func changed(minute: Int) -> Date? {
        changed(year: nil, month: nil, day: nil, hour: nil, minute: minute, second: nil, nanosecond: nil)
    }
    ...
    public func changed(second: Int) -> Date? {
        changed(year: nil, month: nil, day: nil, hour: nil, minute: nil, second: second, nanosecond: nil)
    }
    ...
    public func changed(nanosecond: Int) -> Date? {
        changed(year: nil, month: nil, day: nil, hour: nil, minute: nil, second: nil, nanosecond: nanosecond)
    }
    ...
    public func changed(weekday: Int) -> Date? {
        self - (self.weekday - weekday).days
    }
    ...
    public func string(inDateStyle dateStyle: DateFormatter.Style, andTimeStyle timeStyle: DateFormatter.Style) -> String {
        stringIn(dateStyle: dateStyle, timeStyle: timeStyle)
    }
    ...
    public func dateString(in dateStyle: DateFormatter.Style) -> String {
        stringIn(dateStyle: dateStyle, timeStyle: .none)
    }
    ...
    public func timeString(in timeStyle: DateFormatter.Style) -> String {
        stringIn(dateStyle: .none, timeStyle: timeStyle)
    }
}
